...
public class DragAndDropMethod {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement target1 = driver.findElement(By.xpath("//ol[@id='loan']/descendent::li"));
		
		WebElement src3 = driver.findElement(By.xpath("//a[text()='5000']"));
		WebElement target3= driver.findElement(By.xpath("//ol[@id='amt8']/descendent::li"));
		
		
		WebElement src2 = driver.findElement(By.xpath("//a[text()='BANK']"));
		WebElement target2= driver.findElement(By.xpath("//ol[@id='bank']/descendent::li"));
		
		
		WebElement src4 = driver.findElement(By.xpath("//a[text()='5000']"));
		WebElement target4= driver.findElement(By.xpath("//ol[@id='amt7']/descendent::li"));
